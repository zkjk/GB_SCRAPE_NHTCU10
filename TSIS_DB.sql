...
-- Wed 19 Jun 2019 04:38:33 AM PDT
...
-- Schema osintdb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `osintdb` DEFAULT CHARACTER SET utf8 ;
USE `osintdb` ;
...
CREATE TABLE IF NOT EXISTS `osintdb`.`Company` (
  ...
  `CEO` VARCHAR(50) NULL DEFAULT NULL,
  `FoundedIn` DATE NULL DEFAULT NULL,
  `EmployeeAmount` VARCHAR(50) NULL DEFAULT NULL,
  `Size` VARCHAR(25) NULL DEFAULT NULL,
  `CompanySector` VARCHAR(50) NULL DEFAULT NULL,
  `ScrapeDate` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `osintdb`.`Address` (
  ...
  `StreetNumber` VARCHAR(15) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `osintdb`.`Finance` (
  ...
  `VAT` VARCHAR(50) NULL DEFAULT NULL,
  `Debt` DOUBLE NULL DEFAULT NULL,
  `DebDate` DATE NULL DEFAULT NULL,
  `SocialInsuranceTaxes` DOUBLE NULL DEFAULT NULL,
  `SocialInsuranceTaxesDate` DATE NULL DEFAULT NULL,
  `SocialSecurityInsurerCodes` VARCHAR(150) NULL DEFAULT NULL,
  `Company_UUIDCompany` VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `osintdb`.`Internet` (
  ...
  `RecordMaintainedBy` VARCHAR(50) NULL DEFAULT NULL,
  `DNS` VARCHAR(50) NULL DEFAULT NULL,
  `Company_UUIDCompany` VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `osintdb`.`SubDomain` (
  ...
  `Domain_Domain` VARCHAR(50) NOT NULL,
  `Internet_IPAddress` INT(11) NOT NULL,
